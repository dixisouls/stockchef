        ...
        contents = [
            types.Content(
                ...
                parts=[
                    ...
                    Two recipes aligning to cuisine preference, one can be a random cuisine. Try to not give the previous recipe, 
                    but if there are no ingredients, then you can return the same recipe. If you can make a recipe out of the ingredients 
                    but cannot adhere to the cuisine preference, then still return it but make sure to strictly align to dietary preference. 
                    If you cannot return three recipes, that's fine—return as many as you can generate, but a maximum of three. You don't 
                    need to utilize all the available ingredients, I mean you can use all, or a subset.

                    Follow these steps in returning the output:

                    1) 200 if you can at least generate one, 400 if you cannot generate any or the ingredient list has nothing. Make sure, 
                       if you cannot generate any recipe to return 400. and 200 if you can generate at least 1.
                    2) First recipe
                        ...
                        2.4) ingredient list as needed(make sure available from the original list provided to you), only the ingredients, 
                    ...
                    3) Second recipe
                        ...
                        3.4) ingredient list as needed(make sure available from the original list provided to you), only the ingredients, 
                             nothing else such as 1 pound, for garnish etc, just the ingredient list.
                    ...
                    4) Third recipe
                        ...
                        4.4) ingredient list as needed(make sure available from the original list provided to you), only the ingredients, 
                             nothing else such as 1 pound, for garnish etc, just the ingredient list.
            ...
            types.Content(
                role="user",
                parts=[
                    types.Part.from_text(json.dumps(input_payload)),
                ],
            ),
        ]
